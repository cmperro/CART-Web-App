...
session_start();
/** 
*<p>This script takes the uploaded file and saves a spreadsheet in a local directory. 
...
*The answer key is saved in an array. The student answers are then parsed into a 2D-array.</p>
*
